...
export default function CertificateScreen() {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            if (result?.error) {
                Alert.alert("Sync Error", "Certificate saved but backend sync failed: " + result.error);
            }
            ...
            Alert.alert("Sync Error", "Could not sync to server. Will retry later.");
        } finally {
            setSyncing(false);
        }
    };
                    ...
                    <View style={styles.successContainer}>
                        ...
                        <View style={styles.verifyBox}>
                            ...
                            <Text style={styles.verifyInfo}>
                                ...
                                <Text style={styles.verifyLink}>https://urduai.org/verify/?id={certificateId}</Text>
                            </Text>
                        </View>
