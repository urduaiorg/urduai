        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          {loading ? (
            ...
            <>
              ...
              <TouchableOpacity style={styles.newsCard} activeOpacity={0.9} onPress={() => router.push({ pathname: '/article-reader', params: { url: 'https://urduai.org' } })}>
                <View style={styles.newsImageContainer}>
                  <Image source={{ uri: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&q=80&w=800' }} style={styles.newsImage} />
                </View>
                <View style={styles.newsContent}>
                  <View style={styles.newsHeaderRow}>
                    ...
                    <Text style={styles.newsDate}>6 مارچ</Text>
                  </View>
                  <Text style={styles.newsTitle}>گوگل اور میساچوسٹس اے آئی ہب کا نیا اقدام، ریاست بھر میں مفت اے آئی تربیت کا آغاز</Text>
                  <Text style={styles.newsExcerpt} numberOfLines={2}>گوگل اور میساچوسٹس اے آئی ہب کا نیا اقدام، ریاست بھر میں مفت اے آئی تربیت کا آغاز دنیا بھر میں مصنوعی ذہانت اب محض ایک تکن...</Text>
              ...
              <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.blogScroll}>
                {[
                  { id: 1, title: 'چیٹ جی پی ٹی کے 5 حیرت انگیز استعمال', date: '5 مارچ', image: 'https://images.unsplash.com/photo-1620712943543-bcc4688e7485?auto=format&fit=crop&q=80&w=400' },
                  { id: 2, title: 'مصنوعی ذہانت سے پیسے کیسے کمائیں؟', date: '3 مارچ', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&q=80&w=400' },
                  { id: 3, title: 'مستقبل کی نوکریاں اور AI کا کردار', date: '1 مارچ', image: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&q=80&w=400' },
                ].map((blog) => (
                  <TouchableOpacity key={blog.id} style={styles.miniBlogCard} activeOpacity={0.9} onPress={() => router.push({ pathname: '/article-reader', params: { url: 'https://urduai.org' } })}>
                    ...
                    <LinearGradient colors={['transparent', 'rgba(0,25,51,0.9)']} style={styles.miniBlogOverlay}>
                      <Text style={styles.miniBlogDate}>{blog.date}</Text>
              ...
              {/* Daily AI Tip */}
              <LinearGradient colors={['rgba(255, 215, 0, 0.15)', 'rgba(255, 215, 0, 0.05)']} style={styles.tipCard} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}>
                <View style={styles.tipHeader}>
                  <Ionicons name="bulb" size={22} color="#FFD700" />
                  <Text style={styles.tipTitle}>آج کی AI ٹپ</Text>
                </View>
                <Text style={styles.tipText}>پرامپٹ لکھتے وقت ہمیشہ AI کو ایک "کردار" (Role) دیں، جیسے *"ایک ماہر کاپی رائٹر کے طور پر..."*، اس سے جواب کا معیار 10 گنا بہتر ہو جائے گا۔</Text>
              </LinearGradient>
